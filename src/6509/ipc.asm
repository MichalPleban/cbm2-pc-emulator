...
;--------------------------------------------------------------------
; The following 48 bytes seem to be random garbage.
; The system works fine when they are zeroed.
;--------------------------------------------------------------------
...
;--------------------------------------------------------------------
; Input/output buffer for the IPC functions.
; The location of this buffer is hardcoded to $0805 in the KERNAL.
;--------------------------------------------------------------------
    
ipc_buffer:
	.byt $c9,$03,$d0,$08,$20,$d1,$15,$90,$03,$4c,$3b

;--------------------------------------------------------------------
; More garbage follows.
;--------------------------------------------------------------------

 	.byt $0d,$ad,$a4,$02,$f0,$09,$a9,$03
    .byt $a8,$ae,$aa,$02,$4c,$69,$10,$a9
    .byt $01,$8d,$a4,$02,$ae,$af,$02,$20
    .byt $16,$11,$b0,$07,$a9,$08,$a0,$03
    
;--------------------------------------------------------------------
; Jump table to IPC functions.
...
;--------------------------------------------------------------------
	...
	.byt $69,$10,$ad,$a5,$02,$f0,$2e,$a9
    .byt $01,$2d,$00,$01,$02,$03,$04,$05
    .byt $06,$07,$08,$09,$0a,$0b,$0c,$0d
	.byt $0e,$0f,$40,$40,$23,$23,$23,$30
    .byt $4b,$4b,$40,$30,$23,$25,$00,$55
    .byt $04,$40,$00,$4b,$47
...
;--------------------------------------------------------------------
; These bytes seem to be random garbage padding the file.
;--------------------------------------------------------------------

	.byt $08,$20,$d2,$ff,$e8,$88,$d0
    .byt $f6,$20,$cc,$ff,$20,$b6,$0b
    .byt $b0,$be,$c9,$30,$d0
